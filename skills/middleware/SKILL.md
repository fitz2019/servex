---
name: middleware
description: servex 中间件模块专家。当用户使用 servex 的 ratelimit、circuitbreaker、retry、recovery、timeout、cors、requestid、idempotency、semaphore、logging、secure、csrf、bodylimit、signature、trace 中间件时触发。
---
