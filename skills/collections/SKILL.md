---
name: collections
description: servex 集合库专家。当用户使用 servex 的 blockingqueue、delayqueue、deque、hashset、linkedmap、lrucache、mapsx、multimap、priorityqueue、slicesx、treemap、treeset 时触发，提供泛型集合数据结构的完整用法和示例。
---
