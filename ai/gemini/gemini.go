...
func (c *Client) buildRequest(messages []ai.Message, o ai.CallOptions) generateRequest {
	req := generateRequest{}
...
// convertMessage 将 ai.Message 转换为 Gemini 格式.
func (c *Client) convertMessage(msg ai.Message) *geminiContent {
	role := "user"
...
// convertResponse 将 Gemini 响应转换为 ai.Message.
func (c *Client) convertResponse(content geminiContent) ai.Message {
