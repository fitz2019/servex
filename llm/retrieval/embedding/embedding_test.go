...
func (m *mockEmbeddingModel) EmbedTexts(_ context.Context, texts []string, _ ...llm.CallOption) (*llm.EmbedResponse, error) {
	m.callCount++
	...
	return &llm.EmbedResponse{
		...
		Usage:      llm.Usage{PromptTokens: len(texts), TotalTokens: len(texts)},
		ModelID:    "mock-model",
	}, nil
}
